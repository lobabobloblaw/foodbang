  ...
  FB.screens.register('bodymax', {
    ...
    render: function () {
      ...
      h += '<div class="trajectory"><div style="display:flex;align-items:baseline;gap:8px">' +
        ...
        '<span style="margin-left:auto;font:800 calc(17px * var(--fs)) var(--display);color:var(--fb)">' + m.trajectory + '</span></div>' +
      ...
      h += '<div style="border-top:8px solid var(--surface-2);margin-top:14px">' +
        FB.C.sectionHead('Wellness recommendations', 'Personalized from your telemetry.') +
      ...
      h += '<div class="fineprint">BODYMAX™ is a wellness feature, not a medical device, not a scale, and not an opinion. ' +
        'Figures are generated by FoodBang™ from your own ordering behavior and are not reviewed by a clinician. ' +
